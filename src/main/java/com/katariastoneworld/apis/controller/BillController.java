...
public class BillController {
    ...
    public ResponseEntity<byte[]> downloadBillByNumber(@PathVariable String billNumber, HttpServletRequest request) {
        try {
            ...
            System.out.println(
                    "Generating PDF for bill number " + billNumber + ": subtotal=" + bill.getSubtotal()
                            + ", totalAmount=" + bill.getTotalAmount()
                            + ", labour=" + bill.getLabourCharge()
                            + ", transportation=" + bill.getTransportationCharge()
                            + ", otherExpenses=" + bill.getOtherExpenses());
